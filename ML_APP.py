	...
	#DEALING WITH THE MODEL BUILDING PART
		...
		def get_classifier(name_of_clf,params):
			...
			if name_of_clf=='SVM':
				...
				clf=KNeighborsClassifier(n_neigbors=params['K'])
			elif name_of_clf=='LR':
...
#DEALING WITH ABOUT US
 		...
 		st.markdown('This is an interactive web page for our ML project, It demonstrate how we can present our work to stakeholders who do not have a background in coding. We have built this web app for our machine learning algorithms using different datasets.We hope you like it')
